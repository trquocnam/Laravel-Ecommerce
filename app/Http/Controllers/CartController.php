...
class CartController extends Controller
{
    public function save_cart(Request $request){
    	...
    	$product_info = FacadesDB::table('tbl_product')->where('product_id',$productId)->first(); 
    ...
    public function show_cart(){
        ...
        return view('frontend.cart.show_cart')->with('category',$cate_product)->with('brand',$brand_product);
    }
